...
/**
 * ContactDepartment Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Spinen\ConnectWise\Clients\Company
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContactDepartment implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContactDepartment';
    ...
    {
        if ((strlen($name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ContactDepartment., must be smaller than or equal to 30.');
        }
