 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContactType implements ArrayAccess
{
    ...
    public function setDescription($description)
    {
        if ((strlen($description) > 50)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ContactType., must be smaller than or equal to 50.');
        }
