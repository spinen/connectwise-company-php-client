 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TeamRole implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TeamRole';
    ...
    {
        if ((strlen($name) > 20)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TeamRole., must be smaller than or equal to 20.');
        }
