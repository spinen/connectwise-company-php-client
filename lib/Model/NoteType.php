 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class NoteType implements ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['import_flag'] = isset($data['import_flag']) ? $data['import_flag'] : null;
    ...
    {
        $invalid_properties = [];
        if (!is_null($this->container['identifier']) && (strlen($this->container['identifier']) > 15)) {
    ...
    {
        if (!is_null($identifier) && (strlen($identifier) > 15)) {
            throw new \InvalidArgumentException('invalid length for $identifier when calling NoteType., must be smaller than or equal to 15.');
        }
    ...
    {
        if ((strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NoteType., must be smaller than or equal to 50.');
        }
    ...
    {
        return $this->container['import_flag'];
    }

    /**
     * Sets import_flag
     * @param bool $import_flag
     * @return $this
     */
    public function setImportFlag($import_flag)
    {
        $this->container['import_flag'] = $import_flag;
