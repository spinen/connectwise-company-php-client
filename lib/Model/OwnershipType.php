 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OwnershipType implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OwnershipType';
    ...
    {
        if ((strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OwnershipType., must be smaller than or equal to 200.');
        }
