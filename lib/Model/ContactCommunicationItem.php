...
/**
 * ContactCommunicationItem Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Spinen\ConnectWise\Clients\Company
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContactCommunicationItem implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContactCommunicationItem';
    ...
    {
        if ((strlen($value) > 250)) {
            throw new \InvalidArgumentException('invalid length for $value when calling ContactCommunicationItem., must be smaller than or equal to 250.');
        }
    ...
    public function setExtension($extension)
    {
        if (!is_null($extension) && (strlen($extension) > 15)) {
            throw new \InvalidArgumentException('invalid length for $extension when calling ContactCommunicationItem., must be smaller than or equal to 15.');
        }
