...
/**
 * ConfigurationType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Spinen\ConnectWise\Clients\Company
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ConfigurationType implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConfigurationType';
    ...
    {
        if ((strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ConfigurationType., must be smaller than or equal to 50.');
        }
