...
/**
 * ContactRelationship Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Spinen\ConnectWise\Clients\Company
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContactRelationship implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContactRelationship';
    ...
    {
        if ((strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ContactRelationship., must be smaller than or equal to 50.');
        }
